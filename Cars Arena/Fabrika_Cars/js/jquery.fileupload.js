...
var myElement = document.getElementsById('myImg'),
...
'carrier.jpg',
'listaproperty.jpg',
'DS-2CE56D1T-IRM_1-700x7500',
'membership_banner-arabic'
...
( function(){
	...
	$('.message').html('<span> + maxtext + </span> characters left')
	$('.textarea').keyup(function(){
		var textlength = $(this).val().length;
		remChars = maxtext - textlength;
		$('.message').html('<span> + remchars + </span> characters left')
	});
